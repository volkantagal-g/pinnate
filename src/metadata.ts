...
export const componentMetadata: ComponentMetadata[] = [
  ...
  },
  {
    ...
    props: {
      ...
      color:
        ' | gray | purple | getir | red | orange | green | yellow | riteg | blue | pink | teal',
      iconPosition: 'start | end',
      tone: 'filled | light',
      permissionId: 'string',
    },
  ...
  },
  {
    ...
    props: {
      children: 'React.ReactNode',
      variant:
        'display-xl | display-lg | display-md | display-sm | display-xs | text-xl | text-lg | text-md | text-sm | text-xs | text-x2s',
