...
function Intro() {
  ...
  return (
    <section style={{ display: 'grid', gap: 8 }}>
      ...
      <p style={textStyle}>
        Design tokens are the single source of truth for visual decisions (color, typography,
        spacing, radius, etc.). They let us theme Pinnate consistently, change styles in one place,
        and ship UIs that look and feel the same across products.
      </p>
      <p style={textStyle}>
        Tokens are exposed to components as CSS variables at runtime via the{' '}
        <code style={code}>PinnateProvider</code>. Any component style references a variable instead
        of hard-coded values. When a token changes, every component updates automatically.
      </p>
